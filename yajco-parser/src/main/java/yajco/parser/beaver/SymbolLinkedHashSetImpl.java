...
public class SymbolLinkedHashSetImpl<T> extends Symbol implements Set<T> {
    ...
    public boolean add(T t) {
        // Check equality even if objects are not the same instances.
        // Default implementation ignores equals method if objects are not the same instance.
        boolean unique = true;
